package net.reaper.ANTeam.ancientnature.common.particle;
...
public class LeafsParticle extends TextureSheetParticle {
    ...
    protected LeafsParticle(ClientLevel pLevel, double pX, double pY, double pZ,
                            SpriteSet spriteSet, float particleRandom, float spinAcceleration, double pXSpeed, double pYSpeed,
                            double pZSpeed) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            return new LeafsParticle(pLevel, pX, pY, pZ, this.spriteSet,12,-5, pXSpeed, pYSpeed, pZSpeed);
        }
    }
}