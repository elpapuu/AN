...
import net.reaper.ANTeam.ancientnature.common.block.*;
...
public class ANBlocks {
    ...
    public static final DeferredBlock<Block> LEPIDODENDRON_SIGN = BLOCKS.register("lepidodendron_sign", () -> new ANStandingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN), ANWoodTypes.LEPIDODENDRON));
    public static final DeferredBlock<Block> LEPIDODENDRON_WALL_SIGN = BLOCKS.register("lepidodendron_wall_sign", () -> new ANWallSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN), ANWoodTypes.LEPIDODENDRON));

    public static final DeferredBlock<CeilingHangingSignBlock> LEPIDODENDRON_HANGING_SIGN = BLOCKS.register("lepidodendron_hanging_sign", () -> new ANHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN), ANWoodTypes.LEPIDODENDRON));
    public static final DeferredBlock<WallHangingSignBlock> LEPIDODENDRON_WALL_HANGING_SIGN = BLOCKS.register("lepidodendron_wall_hanging_sign", () -> new ANWallHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN), ANWoodTypes.LEPIDODENDRON));
    ...
    public static final DeferredBlock<LogDropperBlock> AMBER_GINKGO_LOG = makeItemDropperBlock("amber_ginkgo_log");
    ...
    public static final DeferredBlock<Block> GINKGO_SIGN = BLOCKS.register("ginkgo_sign", () -> new ANStandingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN), ANWoodTypes.GINKGO));
    public static final DeferredBlock<Block> GINKGO_WALL_SIGN = BLOCKS.register("ginkgo_wall_sign", () -> new ANWallSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN), ANWoodTypes.GINKGO));
    public static final DeferredBlock<CeilingHangingSignBlock> GINKGO_HANGING_SIGN = BLOCKS.register("ginkgo_hanging_sign", () -> new ANHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN), ANWoodTypes.GINKGO));
    public static final DeferredBlock<WallHangingSignBlock> GINKGO_WALL_HANGING_SIGN = BLOCKS.register("ginkgo_wall_hanging_sign", () -> new ANWallHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN), ANWoodTypes.GINKGO));
    ...
    public static DeferredBlock<LogDropperBlock> makeLogDropperBlock(String name) {
        return registerBlock(name,
                ...
                () -> new LogDropperBlock(
                        BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG).requiresCorrectToolForDrops().strength(2f)
                )
        );
    }
    public static DeferredBlock<LogDropperBlock> makeItemDropperBlock(String name) {
        return registerBlock(name,
